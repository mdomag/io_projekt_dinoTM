...
int main() {
    ...
    // vector<Character> characters = charactersDB->characters;
    // for(auto character: characters){
    //     character.showInfo();
    // }
    // ShopMenu* shopMenu = new Shop(charactersDB, currentPlayer);
    // currentPlayer->showCharacters();
    // shopMenu->showMenu();
    // currentPlayer->showCharacters();
    // currentPlayer->openTeamMenu();
    // FightMenu* fight = new Fight(currentPlayer, charactersDB);
    // fight->showMenu();
